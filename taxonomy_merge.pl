...
die "\nmerges the taxonomies from the two phylogenetic strategies and generates a consensus.\n\nUsage: perl taxonomy_merge.pl <strategy1.results.tsv> <strategy2.results.tsv> <confidence_threshold>\n\n" unless @ARGV == 3;

my ($comp_tax, $epa_tax, $conf_threshold) = @ARGV;
